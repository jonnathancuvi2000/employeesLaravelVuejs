...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        <div class="navBar fixed top-0 right-0 px-6 py-4">
            <div class="img-container">
                <img class="img" src="{{ asset('images/logojc2.png') }}" alt="">
            </div>
            <div>
                @auth
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="contenido mt-8  ">
                ...
                <p>Aplicación Web de gestion de empleados</p>
                <div>
                    <!-- <a href="{{ route('login') }}"  class="btn-start"><span></span>Comenzar</a> -->
                    <a href="{{ route('login') }}"  class="btn-start">Comenzar</a>
                    <!-- <a href="{{ route('login') }}" class="btn-start">Log in</a> -->
